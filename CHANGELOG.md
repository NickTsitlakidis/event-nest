...
- **docs:** Add documentation app scaffold ([#68](https://github.com/NickTsitlakidis/event-nest/pull/68))
- **docs:** Add content in docs site ([#69](https://github.com/NickTsitlakidis/event-nest/pull/69))
