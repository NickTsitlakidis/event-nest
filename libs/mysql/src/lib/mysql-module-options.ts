...
export interface MySQLModuleAsyncOptions {
    inject?: never[];
    useFactory: (...parameters: unknown[]) => MySQLModuleOptions | Promise<MySQLModuleOptions>;
}

export interface MySQLModuleOptions extends CoreModuleOptions {
    /**
    ...
    /**
     * A valid connection string which will be used to connect to the MySQL server.
     */
